...
/**
 * Builds the editorial caption both agencies expect:
 *
 ...
 *
 * The app assembles this rather than asking the model for it, so the shape is guaranteed
 * instead of merely requested — a format the model reproduces "usually" is not a format.
 *
...
object EditorialTitle {
    ...
    fun build(location: String?, capturedOn: String?, description: String): String {
        ...
        return if (lead.isEmpty()) body else "$lead: $body"
    }

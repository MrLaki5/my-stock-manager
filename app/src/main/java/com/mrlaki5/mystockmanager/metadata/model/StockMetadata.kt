...
/**
 * IPTC IIM field limits. Exceeding these produces a technically non-conformant
 * record, so values are truncated to fit and the untruncated title also goes into
 * XMP dc:title, which has no such limit.
 */
